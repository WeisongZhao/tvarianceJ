  ...
  implements ActionListener
{
  ...
  public WalkBar_TVJ(String initialMessage, boolean isAbout, boolean isHelp, boolean isClose)
  {
    super("Walk Bar");
    build(initialMessage, isAbout, isHelp, isClose, 100);
  }
  
  public WalkBar_TVJ(String initialMessage, boolean isAbout, boolean isHelp, boolean isClose, int size)
  {
    super("Walk Bar");
...
public synchronized void actionPerformed(ActionEvent e)
  ...
  {
    final JFrame frame = new JFrame("t axial variance for calcium signal profiling" + this.about[0]);
